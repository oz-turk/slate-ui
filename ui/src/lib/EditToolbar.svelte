...
<div class="toolbar">
  ...
  <button class="mode-btn" class:active={mode === 'edit'} on:click={toggleMode}
      on:mouseenter={() => hoverHint.set('Tab: switch between Edit and Preview')}
  ...
  <button class="pin-btn" class:active={pinned} on:click={togglePin}
    ...
    <svg width="11" height="11" viewBox="0 0 24 24" fill={pinned ? 'currentColor' : 'none'} stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      <path d="M12 17v5" />
